...
const myURL = "http://127.0.0.1:5504/";
...
const domeButton = document.getElementById('dome');
...
const fitzCushingButton = document.getElementById('fitzCushing');
fitzCushingButton.addEventListener('click', function(e) {
  console.log('Fitz Cushing button was clicked');
  location.href = myURL.concat("/fitz-cushing") ;
...
const stinRemButton = document.getElementById('stinRem');
